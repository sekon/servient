...
###################################### INITIALIZATION #############################################
SERVIENT_EXIT_SUCCESS=0
SERVIENT_EXIT_ERROR_FATAL_PLGNRN=25
...
SERVIENT_PLGN_MATCH_PRS_EXE="prspctv_mtch"
SERVIENT_PLGN_MATCH_REF_EXE="rfrnc_mtch"
...
SERVIENT_REF_OP_BUFFER="OP_REF"
SERVIENT_PROS_OP_BUFFER="OP_PROS"
####################################### INITIALIZATION ENDS ########################################
